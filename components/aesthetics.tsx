...
const aestheticStyles = [
  { 
    ...
    image: "https://images.unsplash.com/photo-1618721405821-80ebc4b63d26?w=500&auto=format&fit=crop&q=60" 
  },
  { 
    id: 2, 
    name: "SGANDI", 
  ...
  { 
    ...
    name: "Y2K", 
    displayName: "Y2K",
    image: "https://images.unsplash.com/photo-1541779408-c355f91b42c9?w=500&auto=format&fit=crop&q=60" 
  },
  { 
    id: 5, 
    name: "OLD_MONEY", 
  ...
  { 
    ...
    name: "ALT", 
    displayName: "Alt",
    image: "https://images.unsplash.com/photo-1536766820879-059fec98ec0a?w=500&auto=format&fit=crop&q=60" 
  },
  { 
    id: 7, 
    name: "COTTAGECORE", 
    displayName: "Cottagecore",
    image: "https://images.unsplash.com/photo-1595781572981-d63151b232ed?w=500&auto=format&fit=crop&q=60" 
  },
  { 
    id: 8, 
    name: "DOWNTOWN", 
...
export function Aesthetics({ aesthetics, setAesthetics, onBack, onComplete }: AestheticsProps) {
  return (
    <KeyboardAvoidingView
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (aesthetics.includes(style.name as AestheticType)) {
                      ...
                      setAesthetics([...aesthetics, style.name as AestheticType]);
                    }
                  }}
